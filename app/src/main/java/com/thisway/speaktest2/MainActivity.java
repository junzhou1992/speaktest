package com.thisway.speaktest2;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SpeechUtility.createUtility(MainActivity.this, SpeechConstant.APPID + "=58c65dd3");
        initView();
    }
...
//        mIat.startListening(mRecognizerListener);//
                ...
                iatDialog.setListener(new RecognizerDialogListener() {
                    ...
                    public static final String TAG = "RecognizerResult";
                    @Override
                    public void onResult(RecognizerResult recognizerResult, boolean isLast) {

                        String result1 = recognizerResult.getResultString(); //未解析的
                        Log.d(TAG," 没有解析的 :"+ result1);
                        showTip(" 没有解析的 :" + result1) ;
